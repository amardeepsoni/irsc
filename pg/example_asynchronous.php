...
$email = 'amardeep.soni88@gmail.com';
$apiKey = '5CD4D76F-6F46-4CF4-92E5-2ED90C59A637';
...
try {
	...
	$additionalHeaders = array($clConst['SANDBOX_MODE_HEADER'], // Sandbox mode - Scan without consuming any credits and get back dummy results
		$clConst['HTTP_CALLBACK'] . ': https://en7n4t2q826kk.x.pipedream.net/', # For a fast testing of callbacks option we recommend to use http://requestb.in
		$clConst['IN_PROGRESS_RESULT'] . ': https://en7n4t2q826kk.x.pipedream.net/',
