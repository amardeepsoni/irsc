...
$email = 'adrock862@gmail.com';
$apiKey = '0BE43A30-79C9-4A59-ACA6-E3C0B9713E52';
...
try {
	...
	$additionalHeaders = array($clConst['SANDBOX_MODE_HEADER'], // Sandbox mode - Scan without consuming any credits and get back dummy results
		$clConst['HTTP_CALLBACK'] . ': https://entl6mtzbfzds.x.pipedream.net', # For a fast testing of callbacks option we recommend to use http://requestb.in
		//$clConst['IN_PROGRESS_RESULT'].': http://your.website.com/callback/results/,
		//$clConst['EMAIL_CALLBACK'] . ': amardeep.soni88@gmail.com',
	...
	//$process = $clCloud->createByURL("http://example.com", $additionalHeaders);
	$txt = $_POST["txt"];
